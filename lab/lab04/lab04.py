...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    dLat = get_lat(city_a) - get_lat(city_b)
    dLon = get_lon(city_a) - get_lon(city_b)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    targetCity = make_city('targetCity', lat, lon)
    if distance(targetCity, city_a) > distance(targetCity, city_b):
